...
const HUD: React.FC<Props> = ({ status, stats, onPause }) => {
  ...
  return (
    <div className="absolute top-0 left-0 w-full h-full pointer-events-none p-2 md:p-6">
      <div className="flex justify-between items-start">
        ...
        <div className="bg-black/60 p-1.5 md:p-3 rounded-xl border-2 border-white/30 text-center flex items-center gap-2 px-2 md:gap-8 md:px-8">
